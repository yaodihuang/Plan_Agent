...
func buildPlanPrompt(query, projectName, parentBranchID string) string {
	...
	sb.WriteString("   - agent: Agent type - 'tdd' (dev/test), 'review' (code review), 'verify' (bug verification)\n")
	...
	sb.WriteString("    {\"step_id\": 4, \"tool_name\": \"parallel_explore\", \"tool_args\": {\"prompt\": \"Integration testing\", \"num_branches\": 1, \"agent\": \"review\"}, \"parallel_group\": null, \"dependencies\": [3]}\n")
	sb.WriteString("  ],\n")
